...
function Partners() {
  return (
    <section className="bg-bottom bg-no-repeat bg-[#0B1120] bottom-10 inset-0 mb-20 pb-4 sm:pb-0">
      <div className="relative mx-auto pt-2 mt-[40px] px-5 sm:px-10">
        <Slide yAxis={90}>
        ...
        <div className="w-full grid grid-cols-[98px,98px,98px,98px,98px,98px] overflow-x-auto md:grid-cols-3 gap-5 sm:py-10 backdrop-blur-md">
          {[
            firstPartner,
            secondPartner,
            thirdPartner,
