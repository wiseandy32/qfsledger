...
function Header() {
  ...
  return (
    <>
      <header className="flex items-center px-2 md:px-5 justify-between h-20 text-slate-200 font-semibold text-sm fixed pt-6 leading-6 w-full bg-[#121826] z-[1000]">
        <MobileNav />
        <Link to={"/"}>
          <img src={logo} width={160} height={20} alt="" />
        </Link>
        <nav className="hidden md:flex flex-col md:flex-row gap-16 md:gap-0 pt-24 md:pt-0 md:justify-end items-center capitalize fixed md:static h-[100vh] md:h-auto w-[100vw] top-[0] left-[0] z-[999999] bg-[#121826]">
